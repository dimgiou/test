...
class CMS_Controller_Plugin_Acl extends Zend_Controller_Plugin_Abstract {
    ...
    //Controller plug-ins respond to a number of events that have corresponding methods.
    //In this case, you want to validate the user's permission after the request has been processed
